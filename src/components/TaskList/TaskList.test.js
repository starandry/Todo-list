...
describe('TaskList Component', () => {
    it('renders "No tasks for today!" when tasks array is empty', () => {
        ...
        const { asFragment } = render(_jsx(TaskList, { tasks: [], onToggle: mockOnToggle, onDelete: mockOnDelete }))
    ...
    it('renders tasks correctly when tasks array is not empty', () => {
        ...
        const { asFragment } = render(_jsx(TaskList, { tasks: tasks, onToggle: mockOnToggle, onDelete: mockOnDelete }))
